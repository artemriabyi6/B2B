...
export default function Contacts() {
  ...
  return (
    <footer className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-slate-900 to-slate-950 text-white overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 md:mb-16">
          {socials.map((social, index) => (
            ...
            >
              <div className="absolute -inset-2 sm:-inset-3 md:-inset-4 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-lg sm:rounded-xl md:rounded-2xl blur opacity-0 group-hover:opacity-20 transition duration-500" />
      ...
      <div className="absolute bottom-0 left-4 sm:left-1/4 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-gradient-to-r from-blue-900/20 to-cyan-900/10 rounded-full blur-2xl sm:blur-3xl" />
      <div className="absolute top-0 right-4 sm:right-1/4 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-gradient-to-r from-slate-800/20 to-blue-900/10 rounded-full blur-2xl sm:blur-3xl" />
    </footer>
  );
}