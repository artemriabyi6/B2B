      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative group">
            <div className="absolute -inset-1 sm:-inset-2 bg-linear-to-r from-blue-600 via-cyan-500 to-blue-600 rounded-xl sm:rounded-2xl md:rounded-3xl blur opacity-20 sm:opacity-30 group-hover:opacity-30 sm:group-hover:opacity-50 transition duration-500" />
            <div className="relative p-4 sm:p-6 md:p-8 lg:p-10 bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl sm:hover:shadow-2xl transition-all duration-500">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl md:text-5xl font-light text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-cyan-500">
                    -22%
                  </div>
