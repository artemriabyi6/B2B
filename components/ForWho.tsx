...
export default function ForWho() {
  return (
    <section className="py-16 sm:py-24 md:py-32 bg-gradient-to-b from-white to-slate-50">
          ...
          {items.map((item, index) => (
            ...
            >
              <div className="relative">
                <div className="absolute -inset-1 sm:-inset-2 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-xl sm:rounded-2xl blur opacity-0 group-hover:opacity-20 transition duration-500" />
                <div className="relative">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-100 to-cyan-50 rounded-lg mb-4 sm:mb-6 flex items-center justify-center">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-full" />
                  </div>
