    ...
    <section className="py-16 sm:py-24 md:py-32 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 right-0 top-6 sm:top-8 h-0.5 bg-gradient-to-r from-blue-500 via-cyan-400 to-blue-500 hidden md:block" />
            ...
            {steps.map((step, i) => (
              ...
              >
                <div className="relative z-10">
                  ...
                  >
                    <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-full flex items-center justify-center text-white font-medium text-sm sm:text-base md:text-lg">
                      {i + 1}
                    </div>
                  </motion.div>
                  <div>
